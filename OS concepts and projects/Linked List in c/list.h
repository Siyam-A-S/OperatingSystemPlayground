// A .h file, or header file, is a file containing C declarations 
//(such as function prototypes, variable declarations, and macro definitions) 
//that are used by other source files.
